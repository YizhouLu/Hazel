...
void Sandbox2D::OnUpdate(Hazel::Timestep dt)
{
...

    {
        ...
        Hazel::Renderer2D::DrawQuad({ -5.0f, -5.0f, -0.1f }, { 10.0f, 10.0f }, m_CheckerBoardTexture, 1.0f);
        Hazel::Renderer2D::DrawQuad({ -0.5f, -0.5f, 0.0f }, { 1.0f, 1.0f }, m_CheckerBoardTexture, 2.0f);
